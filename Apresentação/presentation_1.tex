...
\author{Bruno Tondin, Raissan Chedid e Alexandre Balbinot} % Your name
...
Avaliar a possibilidade de detecção de partos prematuros ou não-prematuros utilizando lógica {\em fuzzy}.
