...
\Title{Characterization of Birth Contractions Based on Fuzzy Techiniques}

% If this is an expanded version of a conference paper, please cite it here: enter the full citation of your conference paper, and add $^\dagger$ in the end of the title of this article.
%\conference{Title}

% Authors, for the paper (add full first names)
\Author{Raissan Chedid $^{1,\ddagger}$, Bruno Tondin $^{1,\ddagger}$ and Alexandre Balbinot $^{1,\ddagger}$}

% Authors, for metadata in PDF
\AuthorNames{Raissan Chedid, Bruno Tondin and Alexandre Balbinot}
